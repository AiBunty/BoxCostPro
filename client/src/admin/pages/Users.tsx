...
function StatusBadge({ status }: { status: string }) {
  const colors: Record<string, string> = {
    ...
    setup_incomplete: 'bg-gray-100 text-gray-800',
    setup_completed: 'bg-cyan-100 text-cyan-800',
    inactive: 'bg-gray-100 text-gray-800',
  };
  const labels: Record<string, string> = {
    new_user: 'New',
    setup_incomplete: 'Setup Incomplete',
    setup_completed: 'Setup Complete',
    verification_pending: 'Pending Approval',
    approved: 'Approved',
    rejected: 'Rejected',
    suspended: 'Suspended',
    active: 'Active',
